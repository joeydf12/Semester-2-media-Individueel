...
function myFunction() {
    ...
    console.log("klik op hamburgermenu")
    ...
    let buttonswitch = document.getElementsByClassName("buttonswitch")[0];
    
    window.scrollTo({ top: 0, left: 0, behavior: 'smooth' });
    console.log("het werkt na boven")

    buttonswitch.style.marginTop = "55%"
  ...
  function hamburger(){
    let iconhamburger = document.getElementsByClassName("iconhamburger")[0]; 
    iconhamburger.style.backgroundColor = "transparent";
    console.log("werkt")
  }
